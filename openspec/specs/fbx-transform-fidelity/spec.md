# fbx-transform-fidelity Specification

## Purpose
Preserve FBX transform stack semantics, pivot reconstruction, instancing, and mirrored handedness across round-trip workflows.
